      ...
      <article className="px-4 pb-8 sm:pb-10">
        <div className="mx-auto max-w-5xl">
          ...
          <section className="overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 p-8 text-white shadow-xl transition-colors duration-300 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 sm:p-10">
            ...
            <p className="max-w-3xl text-lg leading-relaxed text-slate-200 dark:text-gray-300">
              Our direction and purpose are focused on creating practical impact
              through local-first software and digital systems.
            </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            {/* Vision Card */}
            <section className="rounded-2xl border border-teal-100 bg-teal-50/40 p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-teal-900/50 dark:bg-teal-950/30">
              <h2 className="mb-3 text-2xl font-semibold text-teal-800 dark:text-teal-400">
                Vision
              </h2>
            ...
            {/* Mission Card */}
            <section className="rounded-2xl border border-cyan-100 bg-cyan-50/40 p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-cyan-900/50 dark:bg-cyan-950/30">
              <h2 className="mb-3 text-2xl font-semibold text-cyan-800 dark:text-cyan-400">
                Mission
              </h2>
              <p className="leading-relaxed text-gray-700 dark:text-gray-300">
