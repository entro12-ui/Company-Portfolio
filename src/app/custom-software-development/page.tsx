            ...
            <header className="mb-12 rounded-3xl bg-gradient-to-br from-slate-50 via-white to-cyan-50 px-6 py-12 shadow-sm transition-colors duration-300 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 sm:px-10">
              ...
              <p className="max-w-4xl text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                <Link
                  ...
                  className="font-medium text-teal-700 underline decoration-teal-300 underline-offset-4 transition hover:text-teal-800 hover:decoration-teal-500 dark:text-teal-400 dark:hover:text-teal-300"
                >
                  SMEs
                </Link>
                ,{" "}
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-colors duration-300 dark:border-gray-700 dark:bg-gray-800">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  Custom software is built around your process, so your team
                  works faster with fewer errors.
                </p>
              </section>
                ...
                <ol className="space-y-3 text-gray-700 dark:text-gray-300">
                  {[
                    ...
                    <li
                      ...
                      className="flex items-start gap-3 leading-relaxed"
                    >
                      <span className="mt-0.5 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-slate-800 text-sm font-bold text-white dark:bg-teal-600">
                        {index + 1}
                      </span>
                      <span>{item}</span>
                    </li>
              ...
              <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-colors duration-300 dark:border-gray-700 dark:bg-gray-800">
                ...
                <div className="space-y-5 text-gray-700 dark:text-gray-300">
                  ...
                  <div>
                    ...
                    <p>
                      Yes. We integrate with accounting software, payroll,
                      Excel, and other tools you already use.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">
