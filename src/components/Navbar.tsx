        ...
        <div className="flex justify-between items-center w-full h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-6">
            ...
            <div className="flex items-center space-x-4 lg:space-x-8">
              ...
              <Link
                href="/contact"
                className={`${outlineButtonClass} text-sm font-medium`}
              >
                Contact Us
              </Link>
            </div>

            {/* Right side items: Search, Theme Toggle, GitHub, New */}
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <a
                ...
                className={`flex items-center gap-1.5 rounded-full border ${borderClass} px-3 py-1.5 text-sm transition-all hover:bg-white/10`}
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
              ...
              <button
                className={`flex items-center gap-1 rounded-full border ${borderClass} px-3 py-1.5 text-sm font-medium transition-all hover:bg-white/10`}
              >
                ✨ New
              </button>
            </div>
      ...
      >
        ...
        >
          <div className="px-4 pt-4 pb-6 space-y-3 sm:px-6">
            ...
            {/* Actions row: Theme Toggle, GitHub, New */}
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`flex items-center gap-1.5 rounded-full border ${borderClass} px-3 py-2 text-sm transition hover:bg-white/10`}
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
              ...
              <button
                className={`flex items-center gap-1 rounded-full border ${borderClass} px-3 py-2 text-sm font-medium transition hover:bg-white/10`}
              >
                ✨ New
              </button>
            </div>
