export const faqItems = [
  ...
  {
    question:
      "How does the Car Service Management System help auto service centers?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Security is our top priority across all solutions. Our systems feature encrypted communication, comprehensive audit trails, role-based permissions, and continuous monitoring. MediCare AI is HIPAA-compliant with secure patient data handling. All systems include tamper-proof logging and instant alerts for suspicious activity.",
  },
  {
  ...
  {
    question:
      "Can the Car Service Management System track service history and send reminders?",
    answer:
  ...
  {
    question:
      "How does MediCare AI's AI features help healthcare providers?",
    answer:
